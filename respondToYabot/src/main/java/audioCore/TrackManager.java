...
/**
 * Created by zekro on 18.06.2017 / 11:30 supremeBot.audioCore dev.zekro.de -
...
public class TrackManager extends AudioEventAdapter {
	...
	/**
	 * PLAYER EVENT: TRACK STARTET Wenn Einreiher nicht im VoiceChannel ist, wird
	 * der Player gestoppt. Sonst connectet der Bot in den Voice Channel des
	 * Einreihers.
	 * 
	 * @param player
	 *            AudioPlayer
	...
	/**
	 * PLAYER EVENT: TRACK ENDE Wenn die Queue zuende ist, verlässt der Bot den
	 * Audio Channel. Sonst wird der nächste Track in der Queue wiedergegeben.
	 * 
	 * @param player
	 * @param track
	 * @param endReason
